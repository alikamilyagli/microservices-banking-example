...
@Component
public class IdempotentWithdrawEventsConsumer {
    ...
    @KafkaListener(
        ...
        groupId = "withdraw-events-listener-account-group",
        containerFactory = "kafkaListenerContainerFactory"
    )
    public void onDepositEvent(ConsumerRecord<String, WithdrawEvent> consumerRecord) throws JsonProcessingException {
        counter.getAndIncrement();
        try {
            accountService.updateOnWithdraw(consumerRecord.value());
